...
import com.weiruan.backend.api.RemoteServiceStationService;
...
public class SysDataScopeService {
    ...
    @DubboReference
    private RemoteServiceStationService remoteServiceStationService;

    public String getRoleCustom(Long roleId) {
        return remoteDataScopeService.getRoleCustom(roleId);
    }

    public String getDeptAndChild(Long userId) {
        return remoteServiceStationService.listChildIdsByUserId(userId);
